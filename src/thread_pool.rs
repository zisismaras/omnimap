//a fork of https://github.com/rust-threadpool/rust-threadpool
//uses a sync_channel based on the number of threads so we can limit the number of scheduled jobs
#![allow(dead_code)]
use std::fmt;
...
impl Builder {
    ...
    pub fn build(self) -> ThreadPool {
        ...
        let (tx, rx) = sync_channel::<Thunk<'static>>(num_threads);
